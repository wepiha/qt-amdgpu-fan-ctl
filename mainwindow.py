...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelFanProfileStatus.setMinimumSize(QtCore.QSize(64, 0))
        ...
        self.labelPerfProfileLabel = QtWidgets.QLabel(self.centralwidget)
        self.labelPerfProfileLabel.setObjectName("labelPerfProfileLabel")
        self.horizontalLayout.addWidget(self.labelPerfProfileLabel)
        self.labelPerfProfile = QtWidgets.QLabel(self.centralwidget)
        self.labelPerfProfile.setObjectName("labelPerfProfile")
        self.horizontalLayout.addWidget(self.labelPerfProfile)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.labelCurrentFan = QtWidgets.QLabel(self.centralwidget)
        self.labelCurrentFan.setMinimumSize(QtCore.QSize(24, 0))
        ...
        self.labelCurrentTemp.setMinimumSize(QtCore.QSize(24, 0))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelPerfProfileLabel.setText(_translate("MainWindow", "Performance Profile:"))
        self.labelPerfProfile.setText(_translate("MainWindow", "..."))
