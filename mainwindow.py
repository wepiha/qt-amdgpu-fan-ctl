...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.labelFanProfileLabel, 0, 0, 1, 1)
        self.labelFanProfileStatus = QtWidgets.QLabel(self.centralwidget)
        self.labelFanProfileStatus.setMinimumSize(QtCore.QSize(72, 0))
        ...
        self.gridLayout_2.addWidget(self.labelFanProfileStatus, 0, 1, 1, 1)
        self.labelFanProfileLabel_2 = QtWidgets.QLabel(self.centralwidget)
        self.labelFanProfileLabel_2.setObjectName("labelFanProfileLabel_2")
        self.gridLayout_2.addWidget(self.labelFanProfileLabel_2, 1, 0, 1, 1)
        self.labelCurrentFan = QtWidgets.QLabel(self.centralwidget)
        self.labelCurrentFan.setMinimumSize(QtCore.QSize(72, 0))
        self.labelCurrentFan.setAlignment(QtCore.Qt.AlignCenter)
        self.labelCurrentFan.setObjectName("labelCurrentFan")
        self.gridLayout_2.addWidget(self.labelCurrentFan, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.labelTemperatureLabel, 0, 0, 1, 1)
        self.labelCurrentTemp = QtWidgets.QLabel(self.centralwidget)
        self.labelCurrentTemp.setMinimumSize(QtCore.QSize(72, 0))
        self.labelCurrentTemp.setAlignment(QtCore.Qt.AlignCenter)
        self.labelCurrentTemp.setObjectName("labelCurrentTemp")
        self.gridLayout_3.addWidget(self.labelCurrentTemp, 0, 1, 1, 1)
        self.labelPerfWattsLabel = QtWidgets.QLabel(self.centralwidget)
        self.labelPerfWattsLabel.setObjectName("labelPerfWattsLabel")
        self.gridLayout_3.addWidget(self.labelPerfWattsLabel, 1, 0, 1, 1)
        self.labelPerfWatts = QtWidgets.QLabel(self.centralwidget)
        self.labelPerfWatts.setMinimumSize(QtCore.QSize(72, 0))
        self.labelPerfWatts.setAlignment(QtCore.Qt.AlignCenter)
        self.labelPerfWatts.setObjectName("labelPerfWatts")
        self.gridLayout_3.addWidget(self.labelPerfWatts, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.graphicsView, 2, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.plainTextEdit, 5, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelFanProfileLabel_2.setText(_translate("MainWindow", "Fan Speed:"))
        ...
        self.labelPerfWattsLabel.setText(_translate("MainWindow", "Power:"))
        self.labelPerfWatts.setText(_translate("MainWindow", "..."))
